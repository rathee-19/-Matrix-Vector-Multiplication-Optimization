...
void matrix_vector_multiply_avx2_omp() {
    // Perform matrix-vector multiplication with AVX2 intrinsics and OpenMP parallelization
...
int main() {
    ...
    matrix_vector_multiply_avx2_omp();
